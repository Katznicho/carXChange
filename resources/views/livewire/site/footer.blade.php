    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1">
                ...
                <p class="text-gray-300 mb-4">Find your dream car with the best deals and professional assistance.</p>
            ...
            <div class="col-span-1">
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-gray-300 hover:text-white">SUVs</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Sedans</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Electric</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Luxury</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Sports Cars</a></li>
                </ul>
            </div>
                ...
                {{-- <div class="mt-6">
                    ...
                    <form class="flex">
                        <input type="email" placeholder="Your email"
                            class="px-4 py-2 w-full rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-600">
                        <button type="submit"
